...
public class CommandReload implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if(sender instanceof ConsoleCommandSender || sender.hasPermission("armostandlimiter.reload")) {
			...
			Bukkit.getServer().getPluginManager().disablePlugin(Bukkit.getServer().getPluginManager().getPlugin(Main.instance.getName()));
			Main.instance.reloadConfig();
			Bukkit.getServer().getPluginManager().enablePlugin(Bukkit.getServer().getPluginManager().getPlugin(Main.instance.getName()));	
